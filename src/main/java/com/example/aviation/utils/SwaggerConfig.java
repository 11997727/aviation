...
public class SwaggerConfig {
    ...
    public Docket docket(){
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
//                .apis(RequestHandlerSelectors.basePackage("com.example.aviation.controller.front"))// 设置basePackage会将包下的所有类的所有方法作为api
    ...
    public ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("航多知识项目说明文档")//标题
                .contact(new Contact("wcz", "", "11997727@qq.com"))//作者 项目链接 邮箱
                .version("1.1")//版本
                .description("航多系统说明").build();
